...
alt <- "Alt text"
cap <- c("Selected ecosystem indicators for ", params$fish, " with time series ranging from ", min(params$esp_data$YEAR), " – present. Upper and lower solid green horizontal lines are plus and minus one standard deviation of the time series mean. Dotted green horizontal line is the mean of the time series.")
...
```{r, traffic-socio-setup, fig.height = 7, fig.width = 6, eval = "Socioeconomic" %in% params$esp_data$INDICATOR_TYPE &  params$esp_type == "report_card"}
alt <- "Alt text"
cap <- c("Selected socioeconomic indicators for ", params$fish, " with time series ranging from ", min(params$esp_data$YEAR), " – present. Upper and lower solid green horizontal lines are plus and minus one standard deviation of the time series mean. Dotted green horizontal line is the mean of the time series.")

knitr::opts_chunk$set(fig.cap = alt)
```


```{r, traffic-socio, fig.height = 7, fig.width = 6, eval = "Socioeconomic" %in% params$esp_data$INDICATOR_TYPE & params$esp_type == "report_card"}
AKesp::esp_traffic(
  dat = params$esp_data %>%
