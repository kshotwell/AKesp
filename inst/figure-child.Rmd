...
AKesp::esp_traffic_long(
  ...
  chunk_label = "traffic-eco-dummy"
)
```

```{r, traffic-socio-dummy, fig.cap = "dummy caption"}
knitr::include_graphics(path = system.file("images/noaa.jpg", package = "AKesp"))
cat("delete the above figure!")
```
...
AKesp::esp_traffic_long(
  ...
  caption = cap,
  ncolumn = params$ncolumn,
  chunk_label = "traffic-socio-dummy"
)
```
